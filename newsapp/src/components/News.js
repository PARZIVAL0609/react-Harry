...
export class News extends Component {
  ...
  async updateNews() {
    const url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=637878ef9cd34b319e0a9d5f72162e3d&page=${this.state.page}&pageSize=${this.props.pageSize}`;
